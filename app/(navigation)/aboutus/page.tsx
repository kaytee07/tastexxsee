...
const AboutUs = () => {
  return (
    <div className=" bg-[#ffd900e1] text-black w-[100vw]">
        ...
        <div className="w-full h-full flex flex-col max-sm:px-8 px-16">
            <h1 className={`text-8xl max-sm:text-6xl mt-7  border-b-2 border-b-black ${libreBaskerville.className}`}>AboutUs</h1>
            <h3 className={`mt-5 text-4xl font-bold ${libreBaskerville.className}`}>Mission</h3>
            <p className={`${latoBold.className} text-2xl`}>Our mission is to use the best quality ingredients to create unique custom dishes that complement our clients’ visions and create memorable experiences. Our elaborate food presentation, elegant settings
                 and proper etiquette are a direct representation of our exceptionally high standards and quality customer service.</p>
            <h3 className={`mt-5 text-3xl font-bold ${libreBaskerville.className}`}>Vision</h3>
            <p className={`border-b-black pb-10 border-b-2 ${latoBold.className} text-2xl`}>Our vision is to inspire through food  while creating a world class gastronomic experience, encompassing the finest quality of food and an unmatched personalized service for private and corporate clients. From board meetings and staff parties to bridal showers ,
        ...
        <div className="core pt-10  px-16">
            <h2 className={`mt-5 text-3xl font-bold ${libreBaskerville.className}`}>Our Core Values</h2>
            <div className="ic flex max-sm:flex-col md:justify-between md:mt-[3rem] mt-6 max-sm:gap-7">
                <div className="excellence flex gap-3 flex-col  items-center justify-center">
                    ...
                    <h1 className={`${latoBold.className} text-xl`}>EXCELLENCE SERVICES</h1>
                </div>
                <div className="excellence flex gap-3 flex-col items-center justify-center">
                    ...
                    <h1 className={`${latoBold.className} text-xl`}>TRUSTWORTHINESS</h1>
                </div>
                <div className="excellence flex gap-3 flex-col items-center justify-center">
                    ...
                    <h1 className={`${latoBold.className} text-xl`}>EFFICIENCY</h1>
                </div>
            </div>
        </div>
